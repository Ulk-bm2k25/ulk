...
const AdminLayout = ({ children, currentPage, onNavigate, onLogout }) => {
  ...
  return (
    <div className="min-h-screen flex bg-brand-bg font-sans">
      {/* Sidebar Desktop */}
      <aside
        className={`hidden md:block fixed h-full z-10 transition-all duration-300 bg-brand-dark ${
        ...
        <header className="bg-white sticky top-0 z-20 px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <div className="relative hidden md:block">
                ...
                <input type="text" placeholder="Rechercher..." className="pl-10 pr-4 py-2 bg-slate-100 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-brand-primary/20 w-64" />
            </div>
