    ...
    >
        ...
        <div className="p-5 border-b border-slate-100 flex justify-between items-start bg-slate-50/50">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500">{data.level} {data.series && `• Série ${data.series}`}</p>
                </div>
            </div>
        ...
        <div className="p-5 flex-1 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
                ...
                <div>
                    <div className="text-[10px] uppercase text-slate-400 font-bold">Prof. Principal</div>
                    <div className="text-sm font-medium text-slate-700">{data.mainTeacher || 'Non assigné'}</div>
                </div>
            </div>
        </div>
