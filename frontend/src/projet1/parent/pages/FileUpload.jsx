...
const FileUpload = ({ label, icon: Icon, selectedFile, onFileSelect, onFileRemove }) => {
    ...
    return (
        <div className="space-y-2 text-left">
            ...
            <div className={`relative group transition-all duration-300 ${selectedFile
                    ? 'border-2 border-green-400 bg-green-500/10'
                    : 'border-2 border-dashed border-white/10 bg-white/5 hover:border-[#eb8e3a] hover:bg-white/10'
